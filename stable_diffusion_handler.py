...
class DiffusersHandler(BaseHandler, ABC):
  ...
  def initialize(self, ctx):
    ...
    try:
      ...
      logger.info("GCS upload is disabled, missing env PROJECT_ID and/or GCS_BUCKET_NAME")
      self.bucket = None
    ...
    self.negative_prompt = (
        ...
        " watermark, logo, banner, extra digits, cropped, jpeg artifacts,"
        " signature, username, error, sketch ,duplicate, ugly, monochrome,"
        " horror, geometry, mutation, disgusting"
    )
    # Negative prompts for realistic character.
    self.negative_prompt += (
        ", bad anatomy, bad hands, three hands, three legs, bad arms, missing"
        " legs, missing arms, poorly drawn face, bad face, fused face, cloned"
        " face, worst face, three crus, extra crus, fused crus, worst feet,"
        " three feet, fused feet, fused thigh, three thigh, fused thigh, extra"
        " thigh, worst thigh, missing fingers, extra fingers, ugly fingers,"
        " long fingers, horn, extra eyes, huge eyes, 2girl, amputation,"
